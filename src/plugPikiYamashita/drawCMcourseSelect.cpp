...
void zen::DrawCMcourseSelect::start()
{
	...
	mBest.hide();
	setBestScore();
	Vector3f pos(320.0f, 240.0f, 0.0);
	mEffectMgr2D->create(EFF2D_Unk25, pos, nullptr, nullptr);
	mEffectMgr2D->create(EFF2D_Unk26, pos, nullptr, nullptr);
	mEffectMgr2D->create(EFF2D_Unk27, pos, nullptr, nullptr);
	mEffectMgr2D->create(EFF2D_Unk28, pos, nullptr, nullptr);
	mEffectMgr2D->create(EFF2D_Unk29, pos, nullptr, nullptr);
	mEffectMgr2D->create(EFF2D_Unk30, pos, nullptr, nullptr);
	mEffectMgr2D->create(EFF2D_Unk31, pos, nullptr, nullptr);
	mEffectMgr2D->create(EFF2D_Unk32, pos, nullptr, nullptr);
	_90 = 0;
	P2DPaneLibrary::setFamilyAlpha(_8C, _90);
	PRINT("start! \n");
}
