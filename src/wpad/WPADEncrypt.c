...
void WPADiCreateKey(s32 chan)
{
	...
	DEBUGPrint("rand: %d %d %d %d %d %d %d %d %d %d\n", tblRnd[0], tblRnd[1], tblRnd[2], tblRnd[3], tblRnd[4], tblRnd[5], tblRnd[6],
	           tblRnd[7], tblRnd[8], tblRnd[9]);

	DEBUGPrint("t0  : %d %d %d %d %d %d %d %d %d %d\n", tb[tblRnd[0]], tb[tblRnd[1]], tb[tblRnd[2]], tb[tblRnd[3]], tb[tblRnd[4]],
	           tb[tblRnd[5]], tb[tblRnd[6]], tb[tblRnd[7]], tb[tblRnd[8]], tb[tblRnd[9]]);
