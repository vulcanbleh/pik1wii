...
void (*__a1_input_reports_array[])(u8 chan, u8* data)
    = { __a1_20_status_report, __a1_21_user_data,  __a1_22_ack,        __a1_unused_report, __a1_unused_report, __a1_unused_report,
	    __a1_unused_report,    __a1_unused_report, __a1_unused_report, __a1_unused_report, __a1_unused_report, __a1_unused_report,
	    __a1_unused_report,    __a1_unused_report, __a1_unused_report, __a1_unused_report, __a1_30_data_type,  __a1_31_data_type,
	    __a1_32_data_type,     __a1_33_data_type,  __a1_34_data_type,  __a1_35_data_type,  __a1_36_data_type,  __a1_37_data_type,
	    __a1_unused_report,    __a1_unused_report, __a1_unused_report, __a1_unused_report, __a1_unused_report, __a1_3d_data_type,
	    __a1_3e_data_type,     __a1_3f_data_type };
	...
	if (!p_wpd->oldFw) {
		for (i = 0; i < 2; i++) {
			...
			if (checkSum == p_buf[index + 10]) {
				...
				obj[0].y       = (s16)(WPAD_DPD_IMG_RESO_WY - 1
				                       - (s16)((s16)(((u16)(p_buf[index + 1])) & 0xFF) | (u16)(((u16)(p_buf[index + 2] & 0xC0)) << 2)));
				obj[0].size    = (u16)p_wpd->dpdDummyObjSize;
				obj[0].traceId = 0;

				obj[1].x = (s16)((s16)((s16)(((u16)(p_buf[index + 3])) & 0xFF) | (u16)(((u16)(p_buf[index + 2] & (u8)(0x30 >> 4))) << 8)));
				obj[1].y
				    = (s16)(WPAD_DPD_IMG_RESO_WY - 1
				...
				obj[2].y       = (s16)(WPAD_DPD_IMG_RESO_WY - 1
				                       - (s16)((s16)(((u16)(p_buf[index + 6])) & 0xFF) | (u16)(((u16)(p_buf[index + 7] & 0xC0)) << 2)));
	...
	if (p_wpd->devType == WPAD_DEV_FREESTYLE || p_wpd->devType == WPAD_DEV_CLASSIC) {
		...
		case WPAD_DEV_FREESTYLE:
			if (index < 0) {
				...
				p_wpd->extConf.fs.acc_0g.x
				    = (s16)((u16)(((u16)(p_buf[index + 0]) << 2) & 0xFFFC) | (u16)(((u16)(p_buf[index + 3]) >> 4) & 3));
				p_wpd->extConf.fs.acc_0g.y
				    = (s16)((u16)(((u16)(p_buf[index + 1]) << 2) & 0xFFFC) | (u16)(((u16)(p_buf[index + 3]) >> 2) & 3));
				p_wpd->extConf.fs.acc_0g.z = (s16)((u16)(((u16)(p_buf[index + 2]) << 2) & 0xFFFC) | (u16)(((u16)(p_buf[index + 3])) & 3));
				p_wpd->extConf.fs.acc_1g.x
				    = (s16)((u16)(((u16)(p_buf[index + 4]) << 2) & 0xFFFC) | (u16)(((u16)(p_buf[index + 7]) >> 4) & 3));
				p_wpd->extConf.fs.acc_1g.y
				    = (s16)((u16)(((u16)(p_buf[index + 5]) << 2) & 0xFFFC) | (u16)(((u16)(p_buf[index + 7]) >> 2) & 3));
...
void __a1_20_status_report(u8 chan, u8* data)
{
	...
	p_status->button       = (u16)((u16)(((u16)((u16)(data[HID_IDX_BYTE7]) & 0xFF) | (u16)((u16)(data[HID_IDX_BYTE8] << 8) & 0xFF00)))
	                               & (u16)HID_WPAD_BUTTON_MASK);
	...
	if (fmt == 3) {
		...
		for (i = 0; i < WPAD_DPD_MAX_OBJECTS; i++) {
			...
			if ((i % 2) == 0) {
				...
				(*p_status)->obj[i].y
				    = (s16)(WPAD_DPD_IMG_RESO_WY - 1 - (s16)((s16)(((u16)y) & 0xFF) | (u16)(((u16)(xy & (u8)(0xC0 >> 4))) << 6)));
			}
...
void __a1_32_data_type(u8 chan, u8* data)
{
	...
	if (p_cb->infos.attach) {
		if (p_cb->devType == WPAD_DEV_FREESTYLE) {
			...
			p_fsStat->fsAccX   = (s16)((s16)((s16)((s16)((s16)(data[HID_IDX_BYTE11]) << 2) & (s16)0xFFFC)
			                                 | (s16)((s16)(data[HID_IDX_BYTE14] >> 2) & (s16)(0x0003)))
			                           - (s16)(p_cb->extConf.fs.acc_0g.x));
			p_fsStat->fsAccY   = (s16)((s16)((s16)((s16)((s16)(data[HID_IDX_BYTE12]) << 2) & (s16)0xFFFC)
			                                 | (s16)((s16)(data[HID_IDX_BYTE14] >> 4) & (s16)(0x0003)))
			                           - (s16)(p_cb->extConf.fs.acc_0g.y));
			p_fsStat->fsAccZ   = (s16)((s16)((s16)((s16)((s16)(data[HID_IDX_BYTE13]) << 2) & (s16)0xFFFC)
			                                 | (s16)((s16)(data[HID_IDX_BYTE14] >> 6) & (s16)(0x0003)))
			...
			case 1:
				...
				p_clStat->clButton
				    = (u16)((u16)((u16)((u16)(data[HID_IDX_BYTE13]) << 8) & (u16)0xFF00 | (u16)(data[HID_IDX_BYTE14]) & (u16)0xFF)
				            ^ 0xFFFF);
				break;
			...
			case 2:
				...
				p_clStat->clButton
				    = (u16)((u16)((u16)((u16)(data[HID_IDX_BYTE16]) << 8) & (u16)0xFF00 | (u16)(data[HID_IDX_BYTE17]) & (u16)0xFF)
				            ^ 0xFFFF);
				break;
			...
			case 3:
				...
				p_clStat->clButton
				    = (u16)((u16)((u16)((u16)(data[HID_IDX_BYTE15]) << 8) & (u16)0xFF00 | (u16)(data[HID_IDX_BYTE16]) & (u16)0xFF)
				            ^ 0xFFFF);
				break;
			}
...
void __a1_35_data_type(u8 chan, u8* data)
{
	...
	if (p_cb->infos.attach) {
		if (p_cb->devType == WPAD_DEV_FREESTYLE) {
			...
			p_fsStat->fsAccX   = (s16)((s16)((s16)((s16)((s16)(data[HID_IDX_BYTE14]) << 2) & (s16)0xFFFC)
			                                 | (s16)((s16)(data[HID_IDX_BYTE17] >> 2) & (s16)(0x0003)))
			                           - (s16)(p_cb->extConf.fs.acc_0g.x));
			p_fsStat->fsAccY   = (s16)((s16)((s16)((s16)((s16)(data[HID_IDX_BYTE15]) << 2) & (s16)0xFFFC)
			                                 | (s16)((s16)(data[HID_IDX_BYTE17] >> 4) & (s16)(0x0003)))
			                           - (s16)(p_cb->extConf.fs.acc_0g.y));
			p_fsStat->fsAccZ   = (s16)((s16)((s16)((s16)((s16)(data[HID_IDX_BYTE16]) << 2) & (s16)0xFFFC)
			                                 | (s16)((s16)(data[HID_IDX_BYTE17] >> 6) & (s16)(0x0003)))
			                           - (s16)(p_cb->extConf.fs.acc_0g.z));
			...
			case 2:
				...
				p_clStat->clButton
				    = (u16)((u16)((u16)((u16)(data[HID_IDX_BYTE19]) << 8) & (u16)0xFF00 | (u16)(data[HID_IDX_BYTE20]) & (u16)0xFF)
				            ^ 0xFFFF);
				break;
			...
			case 3:
				...
				p_clStat->clButton
				    = (u16)((u16)((u16)((u16)(data[HID_IDX_BYTE18]) << 8) & (u16)0xFF00 | (u16)(data[HID_IDX_BYTE19]) & (u16)0xFF)
				            ^ 0xFFFF);
				break;
			}
...
void __a1_37_data_type(u8 chan, u8* data)
{
	...
	if (p_cb->dataFormat == WPAD_FMT_CORE || p_cb->dataFormat == WPAD_FMT_CORE_ACC || p_cb->dataFormat == WPAD_FMT_CORE_ACC_DPD
	    || p_cb->dataFormat == WPAD_FMT_FREESTYLE || p_cb->dataFormat == WPAD_FMT_FREESTYLE_ACC
	    || p_cb->dataFormat == WPAD_FMT_FREESTYLE_ACC_DPD || p_cb->dataFormat == WPAD_FMT_CLASSIC
	    || p_cb->dataFormat == WPAD_FMT_CLASSIC_ACC || p_cb->dataFormat == WPAD_FMT_CLASSIC_ACC_DPD) {
		p_status->err = WPAD_ERR_NONE;
	} else {
		p_status->err = WPAD_ERR_INVALID;
	}
	...
	if (p_cb->infos.attach) {
		if (p_cb->devType == WPAD_DEV_FREESTYLE) {
			...
			p_fsStat->fsAccX   = (s16)((s16)((s16)((s16)((s16)(data[HID_IDX_BYTE24]) << 2) & (s16)0xFFFC)
			                                 | (s16)((s16)(data[HID_IDX_BYTE27] >> 2) & (s16)(0x0003)))
			                           - (s16)(p_cb->extConf.fs.acc_0g.x));
			p_fsStat->fsAccY   = (s16)((s16)((s16)((s16)((s16)(data[HID_IDX_BYTE25]) << 2) & (s16)0xFFFC)
			                                 | (s16)((s16)(data[HID_IDX_BYTE27] >> 4) & (s16)(0x0003)))
			                           - (s16)(p_cb->extConf.fs.acc_0g.y));
			p_fsStat->fsAccZ   = (s16)((s16)((s16)((s16)((s16)(data[HID_IDX_BYTE26]) << 2) & (s16)0xFFFC)
			                                 | (s16)((s16)(data[HID_IDX_BYTE27] >> 6) & (s16)(0x0003)))
			                           - (s16)(p_cb->extConf.fs.acc_0g.z));
			...
			case 1:
				...
				p_clStat->clButton
				    = (u16)((u16)((u16)((u16)(data[HID_IDX_BYTE26]) << 8) & (u16)0xFF00 | (u16)(data[HID_IDX_BYTE27]) & (u16)0xFF)
				            ^ 0xFFFF);
				break;
...
void __a1_3e_data_type(u8 chan, u8* data)
{
	...
	p_status->accX        = (s16)((s16)((s16)((s16)((s16)((s16)(data[HID_IDX_BYTE9]) << 2) & (s16)0xFFFC)
	                              ...
	                              - (s16)(p_cb->conf.acc_0g.x));
	p_status->accZ |= (s16)((s16)((s16)((s16)((s16)((s16)(data[HID_IDX_BYTE8]) << 3) & (s16)0xFF00)
	...
	p_status->obj[0].y = (s16)(WPAD_DPD_IMG_RESO_WY - 1
	                           - (s16)((s16)(((u16)(data[HID_IDX_BYTE11])) & 0xFF) | (u16)(((u16)(data[HID_IDX_BYTE12] & 0xC0)) << 2)));
	p_status->exp[0].pixel
	    = (u16)(((s16)((s16)(((u16)(data[HID_IDX_BYTE17]) << 8) & 0xFF00) | (u16)(((u16)(data[HID_IDX_BYTE18] & 0xFF))))) * 64);
	...
	p_status->obj[1].y = (s16)(WPAD_DPD_IMG_RESO_WY - 1
	                           - (s16)((s16)(((u16)(data[HID_IDX_BYTE20])) & 0xFF) | (u16)(((u16)(data[HID_IDX_BYTE21] & 0xC0)) << 2)));
	p_status->exp[1].pixel
	    = (u16)(((s16)((s16)(((u16)(data[HID_IDX_BYTE26]) << 8) & 0xFF00) | (u16)(((u16)(data[HID_IDX_BYTE27] & 0xFF))))) * 64);
...
void __a1_3f_data_type(u8 chan, u8* data)
{
	...
	p_status->accY        = (s16)((s16)((s16)((s16)((s16)((s16)(data[HID_IDX_BYTE9]) << 2) & (s16)0xFFFC)
	                                          | (s16)((s16)((u16)(data[HID_IDX_BYTE7] >> 6)) & (s16)0x0002)))
	                              - (s16)(p_cb->conf.acc_0g.y));
	p_status->accZ |= (s16)((s16)((s16)((s16)((s16)((s16)(data[HID_IDX_BYTE8]) >> 1) & (s16)0x0030)
